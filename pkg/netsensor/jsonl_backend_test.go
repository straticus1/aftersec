...
func TestJSONLBackendEmitsAttributedFlow(t *testing.T) {
	path := writeSink(t, `{"kind":"network_flow","pid":42,"process":"curl","uid":501,"localAddress":"10.0.0.2","localPort":51000,"remoteAddress":"203.0.113.8","remotePort":443,"protocolName":"tcp","bytesSent":12,"bytesReceived":34,"timestamp":100}`+"\n", 0o600)
	...
	if got.ProcessID != 42 || got.RemotePort != 443 || got.Attribution != AttributionExact {
